...
export default function Login() {
    const [account, setAccount] = useState({ id: 1, username: "Lê Thị Nga", password: "12345678" });
    ...
    return (
        <div>
            ...
            <input type="text" placeholder="Nhập username" value={text} onChange={(e) => setText(e.target.value)} />
            <br />
